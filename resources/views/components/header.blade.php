        ...
        <div class="flex items-center justify-between h-20 px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="hidden lg:flex items-center space-x-4">
                    ...
                    <a href="{{ route('register') }}" class="bg-purple-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-purple-500 transition-colors">
                        Sign up
                    </a>
                </div>
                @else
                <div class="hidden lg:flex items-center" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center space-x-2 text-gray-600 hover:text-purple-600">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" :class="{'transform rotate-180': open}" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute right-0 mt-32 w-48 bg-white rounded-lg shadow-lg py-2">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="block w-full text-left px-4 py-2 text-gray-600 hover:bg-purple-50 hover:text-purple-600">
                                Log out
                            </button>
                        </form>
                    </div>
                ...
                <button
                    @click="isOpen = true"
                    class="lg:hidden text-gray-600 hover:text-purple-600"
                >
        ...
        >
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-6 py-4 overflow-y-auto">
                    <div class="space-y-1">
                        <a href="#" class="block px-3 py-4 text-lg font-medium text-gray-600 hover:text-purple-600 border-b border-gray-100">
                            Explore Artists
                        </a>
                        <a href="#" class="block px-3 py-4 text-lg font-medium text-gray-600 hover:text-purple-600 border-b border-gray-100">
                            How It Works
                ...
                <div class="p-6 border-t border-gray-100">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('dashboard') }}" class="block px-3 py-3 text-gray-600 hover:text-purple-600 border-b border-gray-100">
                            Dashboard
                        </a>
                        @if(Auth::user()->is_artist)
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="block w-full text-left px-3 py-3 text-gray-600 hover:text-purple-600 border-b border-gray-100">
                                Log out
                            </button>
                        </form>
                    </div>
